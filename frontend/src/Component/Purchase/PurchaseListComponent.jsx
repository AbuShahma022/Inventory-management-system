...
function PurchaseListComponent() {
  ...
  const { list, listTotal } = useSelector((state) => state.purchase);
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-5 gap-3">
        <h2 className="text-2xl font-semibold text-gray-800">Purchase List</h2>
          ...
          <tbody>
            {list.length > 0 ? (
              list.map((purchase, index) => (
                <tr key={purchase._id} className="hover:bg-gray-50 text-gray-800">
                  ...
                  <td className="p-3 border-b">{purchase.GrandTotal}</td>
                  <td className="p-3 border-b">{purchase.ShippingCost}</td>
                  <td className="p-3 border-b">{purchase.VatTax}</td>
                  <td className="p-3 border-b">{purchase.OtherCost}</td>
                  <td className="p-3 border-b">{purchase.Discount}</td>
                  <td className="p-3 border-b">
                    {dayjs(purchase.CreatedDate).format("DD MMM YYYY")}
                  </td>
